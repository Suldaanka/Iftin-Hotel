...
export default function FooterSection() {
  return (
   <div className=''>
     <footer className="bg-gray-900 dark:bg-gray-950 py-12 px-4 text-gray-300">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li>
                  <a href="#home" onClick={(e) => scrollToSection(e, "home")} className="hover:text-blue-400">
                    Home
                  </a>
                </li>
                <li>
                  <a href="#rooms" onClick={(e) => scrollToSection(e, "rooms")} className="hover:text-blue-400">
                    Rooms & Suites
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#contact" onClick={(e) => scrollToSection(e, "contact")} className="hover:text-blue-400">
                    Contact
                  </a>
                </li>
              </ul>
